...
exports.MealPlannerModule = MealPlannerModule = __decorate([
    (0, common_1.Module)({ controllers: [meal_planner_controller_1.MealPlannerController], providers: [meal_planner_service_1.MealPlannerService], exports: [meal_planner_service_1.MealPlannerService] })
], MealPlannerModule);
