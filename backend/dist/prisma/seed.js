...
const img = (index) => IMAGE_POOL[index - 1] ?? IMAGE_POOL[0];
const meals = [
    {
        ...
        category: 'Italian',
        image: img(1),
        types: [client_1.MealType.LUNCH, client_1.MealType.DINNER],
        ingredients: [
    ...
    },
    {
        ...
        image: img(8),
        types: [client_1.MealType.BREAKFAST, client_1.MealType.DINNER],
        ingredients: [
    ...
    },
    {
        ...
        category: 'Polish',
        image: img(9),
        types: [client_1.MealType.BREAKFAST],
        ingredients: [
    ...
    },
    {
        ...
        category: 'Polish',
        image: img(15),
        types: [client_1.MealType.BREAKFAST, client_1.MealType.SNACK],
        ingredients: [
